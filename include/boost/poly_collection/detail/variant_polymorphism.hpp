...
#ifndef BOOST_POLY_COLLECTION_DETAIL_VARIANT_POLYMORPHISM_HPP
#define BOOST_POLY_COLLECTION_DETAIL_VARIANT_POLYMORPHISM_HPP
...
/* variant polymorphism model */

template<typename... Ts>
struct variant_polymorphism;

template<typename V,typename...Ts>
struct variant_polymorphism_is_subvariant:std::false_type{};
...
struct variant_polymorphism_is_subvariant<
...
struct variant_polymorphism
{
  ...
  struct is_implementation:std::integral_constant< /* idem */
    bool,
    is_terminal<T>::value||
    variant_polymorphism_is_subvariant<T,Ts...>::value
  >{};
